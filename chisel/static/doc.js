...
function typeHref(type) {
    ...
    let paramsOld = chips.decodeParams();
    let params = {};
...
function attrElem(type, attr, optional, nullable) {
    return chips.elem('ul', {'class': 'chsl-constraint-list'}, [
        ...
        !optional && !nullable && !attr ? attrPartsElem({lhs: 'none'}) : null,
    ]);
}
    ...
    return [
        ...
        chips.elem('table', [
            ...
            chips.elem('tr', [
                ...
                chips.elem('td', [attrElem(typedef.type, typedef.attr, false, false)]),
            ]),
        ]),
    ];
}
            ...
            chips.elem('table', [
                ...
                struct.members.map(function (member) {
                    return chips.elem('tr', [
                        ...
                        chips.elem('td', [attrElem(member.type, member.attr, member.optional, member.nullable)]),
